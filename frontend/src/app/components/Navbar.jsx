  ...
  return (
    <nav className="fixed top-0 left-0 right-0 h-[72px] bg-[#000000] border-b border-[#1a1a1a] z-50 px-6 flex items-center justify-between" style={{ fontFamily: "system-ui, sans-serif" }}>
      ...
      <div className="flex items-center gap-3">
        <Link to="/library" className="flex items-center gap-3 group cursor-pointer">
      ...
      <div className="relative flex items-center" ref={dropdownRef}>
        ...
        {dropdownOpen && (
          <div className="absolute top-[40px] right-0 mt-2 bg-[#0a0a0a] border border-[#1a1a1a] py-2 min-w-[120px] shadow-none flex flex-col z-50" style={{ borderRadius: 0 }}>
            <button
