...
- **Intelligent Data Extraction:** Whether it's an article, a PDF, or a YouTube video, Relic processes and extracts readable content efficiently, removing unnecessary noise.
...
- **Frontend:** React, Redux Toolkit, Vite, Tailwind CSS, Framer Motion, D3.js
...
[def]: https://relic-gamma.vercel.app/
