  ...
  try {
    const response = await groq.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: `You are a search query expander. Your job is to expand a short query into closely related specific terms.\n\n` +
          `STRICT RULES:\n` +
        ...
        {
          role: "user",
          content: `Expand this search query into closely related specific terms only: "${query}"`
        }
      ],
      temperature: 0.1,
      max_tokens: 80,
